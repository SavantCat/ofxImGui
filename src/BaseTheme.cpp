...
namespace ofxImGui
{
	...
	void BaseTheme::updateColors()
	{
		...
		style->Colors[ImGuiCol_Button] = ImVec4(col_main_text, 0.16f);
		style->Colors[ImGuiCol_ButtonHovered] = ImVec4(col_main_text, 0.39f);
		style->Colors[ImGuiCol_ButtonActive] = ImVec4(col_main_text, 1.00f);
